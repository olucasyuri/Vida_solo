      ...
      <main className="main-content">
        <Routes>
          ...
          <Route path="/receitas" element={
            <TransactionsList type="receita" title="Receitas" subtitle="Todas as suas entradas financeiras" />
          } />
          <Route path="/despesas" element={
            <TransactionsList type="despesa" title="Despesas" subtitle="Todos os seus gastos" />
          } />
          <Route path="/a-pagar" element={
            <TransactionsList
              type="despesa"
              title="A Pagar"
              subtitle="Contas pendentes de pagamento"
              defaultStatus="pendente"
            />
          } />
          <Route path="/pagas" element={
            <TransactionsList
              type={null}
              title="Pagas"
              subtitle="Lançamentos com status pago"
              defaultStatus="pago"
            />
          } />
